...
<div class="col-md-12" style="max-height: 700px; margin-top: -20px;">
    <button class="btn btn-primary" id="subBT" type="submit" form="subform">保存</button>
            ...
            <c:if test="${paramListRquest==null}">
                ...
                <div class="form-group">
                    ...
                    <div class="form-inline">
                        ...
                        <select class="form-control mb-2 mr-sm-2 mb-sm-0" name="rquestParamType">
                            <option selected>string</option>
                            <option>number</option>
                        </select>

                        <label class="mr-sm-2">是否必填</label>
                        <select class="form-control mb-2 mr-sm-2 mb-sm-0" name="rquestParamrequired"
            ...
            <c:if test="${paramListResponse==null}">
                ...
                <div class="form-group">
                    ...
                    <div class="form-inline">
                        ...
                        <label class="mr-sm-2">参数类型</label>
                        <select class="form-control mb-2 mr-sm-2 mb-sm-0" name="responseParamType">
                            <option selected>string</option>
                            <option>number</option>
                        </select>

                        <label class="mr-sm-2">是否必填</label>
                        <select class="form-control mb-2 mr-sm-2 mb-sm-0" name="responseParamrequired"
                                setVal="${obj.paramrequired}">
                            <option value="是" selected>是</option>
                            <option value="否">否</option>
                        </select>
